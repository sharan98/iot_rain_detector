...
def getFromDb(location, orderBy = None, equalTo = None):
    try:
        if orderBy != None and equalTo != None:
        ...
        print ('equalTo: ' + str(equalTo) + " not found")
    except:
        print ('err, check location: ' + str(location) + ' and orderby: ' + str(orderBy))
    return
